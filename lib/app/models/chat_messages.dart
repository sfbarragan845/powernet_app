...
import '../pages/public/chat/allConstants/firestore_constants.dart';
...
class ChatMessages {
  ...
  ChatMessages({required this.idFrom, required this.idTo, required this.timestamp, required this.content, required this.type});
