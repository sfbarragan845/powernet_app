...
class ChatProvider {
  ...
  ChatProvider({required this.firebaseStorage, required this.firebaseFirestore});
  ...
  void sendChatMessage(String content, int type, String groupChatId, String currentUserId, String peerId) {
    ...
    ChatMessages chatMessages =
        ChatMessages(idFrom: currentUserId, idTo: peerId, timestamp: DateTime.now().millisecondsSinceEpoch.toString(), content: content, type: type);
