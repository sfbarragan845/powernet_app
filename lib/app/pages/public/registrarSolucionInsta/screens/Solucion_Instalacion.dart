...
import 'package:powernet/app/api/internas/public/delete/instalation/api_anular_Instalacion.dart';
import 'package:powernet/app/pages/public/recursos/recursos.dart';

import '../../../../api/internas/public/insert/instalation/api_facturar_Instalacion.dart';
...
class RegistrarInstalacion extends StatefulWidget {
  static Route<dynamic> route() {
    return MaterialPageRoute(
      builder: (context) => RegistrarInstalacion(),
    );
  }

  @override
  _RegistrarInstalacionState createState() => _RegistrarInstalacionState();
}

class _RegistrarInstalacionState extends State<RegistrarInstalacion> {
  List<Productos> items = [];
  List<Productos> itemsAdicionales = [];
  var suma = 0;
  final solucionController =
      TextEditingController(text: global.detalleSoluInstalacion);
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text('Registrar Instalación',
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          children: [
            Container(
              ...
              child: Text(
                  'Cod. ${global.codigo_servicioDetInstalacion} - ${global.clienteDetInstalacion}',
                  style: TextStyle(
                          ...
                          child: Row(
                            ...
                            children: [
                              Radio(
                                  ...
                                  value: 'SI',
                                  groupValue: global.procedeInstalacion,
                                  onChanged: (valueAd) {
                                    this.setState(() {
                                      global.procedeInstalacion =
                                          valueAd.toString();
                              ...
                              Radio(
                                  ...
                                  onChanged: (valueAd) {
                                    this.setState(() {
                                      ...
                                      global.procedeInstalacion =
                                          valueAd.toString();
                                      global.isRealizaInstalacion = false;
                                      //
            ...
            Visibility(
              visible: global.isRealizaInstalacion,
              child: Column(
                                    ...
                                    InkWell(
                                      onTap: () {
                                        ...
                                        Navigator.of(context).pushReplacement(
                                            BuscarProduct.route('INSTALATION'));
                                      },
                                      child: Container(
                                          width: varWidth * 0.6,
        ...
        """; */
                                      ...
                                      child: GestureDetector(
                                        onTap: () {
                                          if (inter == true) {
                                            ...
                                            if (solucionController
                                                .text.isEmpty) {
                                              progressDialog.dismiss();
                                              mostrarError(context,
                                                  'Detalle una solucion para continuar');
                                            } else if (global
                                                .persona_presente.isEmpty) {
                                              progressDialog.dismiss();
                                              mostrarError(context,
                                                  'Campo Nombre del Cliente Vacio');
                                            } else if (global.selectAcomp
                                                    .toString() ==
                                                'Seleccionar') {
                                              progressDialog.dismiss();
                                              mostrarError(context,
                                                  'Seleccione un técnico auxiliar');
                                            } else if (global.fileImageHouse ==
                                                    null ||
                                                global.fileImageInstalation ==
                                                    null) {
                                              progressDialog.dismiss();
                                              mostrarError(context,
                                                  'Adjunte las fotos del servicio');
                                            } /* else if (double.parse(
                                                        txtCant.text == ''
                                                            ? '0'
                                                            : txtCant.text) >
                                              ...
                                              print(global.nTickets.length);
                                              for (var i = 0;
                                                  i <= global.items.length - 1;
                                                  i++) {
                                                if (global.nfacturaSiNo[i] ==
                                                    'SI') {}
                                                items.add(Productos(
                                                    codigo: int.parse(
                                                        global.items[i].codigo),
                                                    nombre_producto:
                                                        global.items[i].nombre,
                                                    cant: global.nTickets[i],
                                                    facturar:
                                                        global.nfacturaSiNo[i],
                                                    tipo: global.items[i].tipo,
                                                    serie_producto:
                                                        global.items[i].serie,
                                                    codigo_serie: global
                                                                .items[i]
                                                                .serie ==
                                                            'SI'
                                              ...
                                              for (var i = 0;
                                                  i <=
                                                      global.itemsAdcionales
                                                          ...
                                                          1;
                                                  i++) {
                                                if (global.nfacturaSiNoAdicional[
                                                        i] ==
                                                    'SI') {
                                                ...
                                                itemsAdicionales.add(Productos(
                                                    codigo: int.parse(global
                                                        .itemsAdcionales[i]
                                                        .codigo),
                                                    nombre_producto: global
                                                        .itemsAdcionales[i]
                                                        .nombre,
                                                    cant: global
                                                        .nTicketsAdicionales[i],
                                                    facturar: global
                                                            .nfacturaSiNoAdicional[
                                                        i],
                                                    tipo: global
                                                        .itemsAdcionales[i]
                                                        .tipo,
                                                    serie_producto: global
                                                        .itemsAdcionales[i]
                                                        .serie,
                                                    codigo_serie:
                                                        global.itemsAdcionales[i].serie ==
                                                                'SI'
                                                            ? int.parse(global
                                                                .serieProductsAdicional[i]
                                                                .codigo)
                                                            : 0,
                                                    nombre_serie: global.itemsAdcionales[i].serie == 'SI' ? global.serieProductsAdicional[i].serie1 : 'SN',
                                                    desc: global.nDescuentoAdicional[i]));
                                              }
                                              print(
                                                  'aqui mi lista para enviar:  ' +
                                                      items.toString());
                                              semifacturaInstalacion(
                                                      global
                                                          .codigo_clienteInstalacion,
                                                      items.toString(),
                                                      global.id_pk,
                                                      global
                                                          .codigo_servicioDetInstalacion,
                                                ...
                                                if (value['success'] == 'OK') {
                                                  setState(() {
                                                    ...
                                                    global.numFactura = value[
                                                        'secuencial_adicional'];
                                                  ...
                                                  mostrarCorrectoMSG(context,
                                                      'No se establecio la conexión con el servidor');
                                                }
                                              });
                                            }
                                          } else {
            ...
            Visibility(
              visible: global.isRealizaInstalacion == true ? false : true,
              child: Column(
                children: [
                  Center(
                      child: CheckboxListTile(
                    ...
                    children: <Widget>[
                      sombra(Card(
                        ...
                        child: TextField(
                          ...
                          decoration: InputDecoration.collapsed(
                              hintText:
                                  "Escriba aquí la razón por la que no se realizá la instalación"),
                        ),
                      )))
                    ],
                  ),
