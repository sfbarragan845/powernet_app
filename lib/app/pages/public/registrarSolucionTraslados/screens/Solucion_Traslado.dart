...
import 'package:powernet/app/api/internas/public/delete/transfer/api_anular_Traslado.dart';
import 'package:powernet/app/api/internas/public/delete/transfer/api_delete_ont.dart';
import 'package:powernet/app/api/internas/public/insert/transfer/api_facturar_Traslado.dart';
import 'package:powernet/app/pages/public/recursos/recursos.dart';

import '../../../../api/internas/public/insert/transfer/api_facturar_pendiente_Traslado.dart';
...
class RegistrarTraslados extends StatefulWidget {
  static Route<dynamic> route() {
    return MaterialPageRoute(
      builder: (context) => RegistrarTraslados(),
    );
  }

  @override
  _RegistrarTrasladosState createState() => _RegistrarTrasladosState();
}

class _RegistrarTrasladosState extends State<RegistrarTraslados> {
  List<Productos> items = [];
  List<Productos> itemsAdicionales = [];
  var suma = 0;
  final solucionController =
      TextEditingController(text: global.detalleSoluTraslados);
  ...
  void initState() {
    ...
    print(global.nDescuento.length);
    print(global.nfacturaSiNo.length);
    ...
    if (global.deleteImg) {
      setState(() {
        ...
        global.tipo_factura_traslado = 'Facturacion Automatica';
  ...
  void valorDelArrayFactProAdicionales() {
    if (global.itemsAdcionales.isNotEmpty) {
      if (global.tipo_factura_traslado == 'Facturacion Automatica') {
...
//FOTO
  ...
  void _openGallery(BuildContext context) async {
    ...
    if (picture != null) {
      setState(() {
        switch (global.numImageHouse) {
          case 1:
            global.imageHouse = picture;
            if (global.imageHouse != null) {
              // Checking if global.imageHouse is not null
              global.fileImageHouse = File(global.imageHouse!
      ...
      setState(() {
        switch (global.numImageHouse) {
          case 1:
            global.imageHouse = picture;
            if (global.imageHouse != null) {
              global.fileImageHouse = File(global.imageHouse!.path);
            }
            break;
        }
      });
    ...
    return Scaffold(
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          children: [
            Container(
              ...
              child: Text(
                  'Cod. ${global.codigo_servicio_DetTraslado_mostrar} - ${global.cliente_DetTraslados}',
                  style: TextStyle(
                          ...
                          child: Row(
                            ...
                            children: [
                              Radio(
                                  ...
                                  value: 'SI',
                                  groupValue: global.procedeTraslado,
                                  onChanged: (valueAd) {
                                    this.setState(() {
                                      global.procedeTraslado =
                                          valueAd.toString();
                              ...
                              Radio(
                                  ...
                                  onChanged: (valueAd) {
                                    this.setState(() {
                                      ...
                                      global.procedeTraslado =
                                          valueAd.toString();
                                      global.isRealizaTraslado = false;
            ...
            Visibility(
              visible: global.isRealizaTraslado,
              child: Padding(
              ...
              child: Container(
                ...
                child: DropdownButtonHideUnderline(
                  child: DropdownButton(
                    ...
                    onChanged: (valor) => {
                      setState(() {
                        global.tipo_factura_traslado = valor.toString();
                        if (global.tipo_factura_traslado ==
                            'Facturar en Oficina') {
                            ...
                            child: Stack(
                              children: [
                                InkWell(
                                  onTap: () {
                                    setState(() {
                                      global.numImageHouse = 1;
                                      _showSelectionDialog(context, 'CASA');
                                    });
                                  },
                                  child: Container(
                                    //radius: 45,
                                    child: global.fileImageHouse == null
                                        ? Image.asset(
                                            'assets/images/placeholder.png',
                                            fit: BoxFit.cover)
                                        : Image.file(
                                            global.fileImageHouse!,
                                          ),
                                    width: varWidth / 1.2,
                                    height: 250,
                                    decoration: BoxDecoration(
                                                                      ...
                                                                      child:
                                                                        ...
                                                                        children: [
                                                                          Radio(
                                                                              ...
                                                                              onChanged: global.tipo_factura_traslado == 'Facturacion Automatica'
                                                                                  ? (value) {
        ...
        """; */
            ...
            Visibility(
              visible: global.isRealizaTraslado == true ? false : true,
              child: Column(
                children: [
                  Center(
                      child: CheckboxListTile(
                    ...
                    children: <Widget>[
                      sombra(Card(
                        ...
                        child: TextField(
                          ...
                          decoration: InputDecoration.collapsed(
                              hintText:
                                  "Escriba aquí la razón por la que no se realizá el traslado"),
                        ),
                      )))
                    ],
                  ),
          ...
          child: GestureDetector(
            onTap: () async {
              if (inter == true) {
                ...
                if (solucionController.text.isEmpty) {
                ...
                } else if (global.selectAcomp.toString() == 'Seleccionar') {
                  progressDialog.dismiss();
                  ...
                  AwesomeDialog(
                          ...
                          btnOkColor: ColorFondo.BTNUBI)
                      .show();
                } else if (global.fileImageHouse == null ||
                    global.fileImageInstalation == null) {
                  progressDialog.dismiss();
                 ...
                 await borrarONT(global.codigo_servicio_DetTraslados,).then((value) {
                    //print(value);
                    /* if(value==null){
                      mostrarErrorMSG(context, 'No se coencto a sevrer');
                      return;
                    }
                    if (value['success'] == 'OK') {
                     mostrarCorrectoMSG(context, value['success']);

                     } else {
                      
                      mostrarErrorMSG(context, value['success']);
                    } */
                  });
                  ...
                  for (var i = 0; i <= global.itemsAdcionales.length - 1; i++) {
                    ...
                    itemsAdicionales.add(Productos(
                        codigo: int.parse(global.itemsAdcionales[i].codigo),
                        ...
                        codigo_serie: global.itemsAdcionales[i].serie == 'SI'
                            ? int.parse(global.serieProductsAdicional[i].codigo)
                            : 0,
                        nombre_serie: global.itemsAdcionales[i].serie == 'SI'
                    ...
                    if (value['success'] == 'OK') {
                      ...
                      if (global.itemsPDF.isEmpty || global.itemsPDF == []) {
                        ...
                        setState(() {
                          ...
                          global.numFactura = value['secuencial_adicional'];
