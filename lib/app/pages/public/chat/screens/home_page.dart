...
class _HomePageState extends State<HomePage> {
  ...
  String currentUserId = Preferences.usrCedula;
  ...
  */
  ...
  void initState() {
    ...
    if (authProvider.getFirebaseUserId()?.isNotEmpty == true) {
      ...
      print('CurrentID es igual a null');
    }*/
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(centerTitle: true, title: const Text('contactos'), actions: [
                ...
                children: [
                  ...
                  Expanded(
                    child: StreamBuilder<QuerySnapshot>(
                      stream: homeProvider.getFirestoreData(FirestoreConstants.pathUserCollection, _limit, _textSearch),
            ...
            Navigator.push(
                ...
                MaterialPageRoute(
                    builder: (context) => ChatPage(
                          peerId: "1846464664649",
                          peerAvatar: Preferences.usrFoto,
                          peerNickname: "JUANITO6",
                          userAvatar: Preferences.usrFoto,
