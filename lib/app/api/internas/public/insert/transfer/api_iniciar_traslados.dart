...
const String FORM = "FORM_INICIAR_TRASLADO"; //formulario a acceder
final String tokenizer = generateMd5(Secret_Token, FORM); //Se genera Token

late Future<dynamic> iniciartraslado;

Future<dynamic> IniciarTraslados(
    String pk, String id_tecnico, double latitud, double longitud) async {
  try {
    var url = Uri.parse(
        '$ROOT/app/$FOLDER/$IDENTYAPP/soportes/api_iniciar_traslado.php');
    final body = {
    ...
    if (response.statusCode == 200) {
      ...
      iniciartraslado = Future.value(data);
      return null;
    }
  } catch (e) {
    //print(e);
