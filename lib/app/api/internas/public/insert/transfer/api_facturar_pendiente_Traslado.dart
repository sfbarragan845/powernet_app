...
late Future<dynamic> semiFacturaPendienteTras;

Future<dynamic> semiFacturaPendienteTraslado(
    String cliente,
    String productos,
    String id_insta,
    String id_Serv,
  ...
  try {
    var url = Uri.parse(
        '$ROOT/app/$FOLDER/transacciones/facturas_pendientes/api_generar_factura_pendiente_traslado.php');
    ...
    if (response.statusCode == 200) {
      ...
      semiFacturaPendienteTras = Future.value(data);
      print(response.statusCode);
      print(body);
    }
    return await semiFacturaPendienteTras;
  } catch (e) {
    print(e);
    return null;
  }
