...
late Future<dynamic> semifacturaMig;

Future<dynamic> semifacturaMigracion(
    String cliente,
    String productos,
    String id_insta,
    String id_Serv,
    ...
    String persona, String cuotasAdicionales) async {
  try {
    var url = Uri.parse(
        '$ROOT/app/$FOLDER/transacciones/facturas/api_generar_factura_migracion.php');
    ...
    if (response.statusCode == 200) {
      ...
      semifacturaMig = Future.value(data);
      print(response.statusCode);
    }
    return await semifacturaMig;
  } catch (e) {
    return null;
    //print(e);
  }
