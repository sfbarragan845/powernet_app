...
late dynamic semifacturapendiente;

Future<dynamic> SemiFacturaPendiente(
  String cliente,
  String id_soporte,
  String id_Serv,
  String catSolucion,
  ...
  semifacturapendiente = null;
  try {
    var url = Uri.parse(
        '$ROOT/app/$FOLDER/transacciones/facturas_pendientes/api_generar_factura_pendiente_soporte.php');
    final body = {
    ...
    if (response.statusCode == 200) {
      ...
      semifacturapendiente = Future.value(data);
      print(response.statusCode);
      print(semifacturapendiente);
      //return null;
    }
    //return await semifacturapendiente;
  } catch (e) {
    //print(e);
    //return null;
  }
  return semifacturapendiente;
}
