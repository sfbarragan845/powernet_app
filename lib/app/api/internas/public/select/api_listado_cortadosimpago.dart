...
const String FORM =
    "FORM_LISTADO_CORTESIMPAGO_PENDIENTES"; //formulario a acceder
final String tokenizer = generateMd5(Secret_Token, FORM); //Se genera Token

//late Future<dynamic> lisInstalaciones;

Future<dynamic> listadoCortadosImpago(String email) async {
  var url = Uri.parse(
      '$ROOT/app/$FOLDER/$IDENTYAPP/soportes/api_listado_cortadosimpago_pendientes.php');
  try {
    final body = {
      "token": tokenizer,
